...
const menuItems = [
  { label: 'Dashboards', path: '/dashboard', icon: <FaChartLine /> },
  { label: 'Inventory', path: '/inventory', icon: <FaBox /> },
  { label: 'Reports', path: '/reports', icon: <FaFileAlt /> },
  { label: 'Requests', path: '/requests', icon: <FaUsers /> },
  { label: 'Ongoing Orders', path: '/orders', icon: <FaTruck /> },
  { label: 'Notifications', path: '/notifications', icon: <FaBell /> },
  { label: 'Help & Support', path: '/contactus', icon: <FaQuestionCircle /> },
];
      ...
      try {
        ...
        if (response.ok) {
          ...
          setProfileData({
            ...
            username: data.name , // Use fetched username or default
            accountType: capitalizedAccountType , // Use capitalized account type or default
          });

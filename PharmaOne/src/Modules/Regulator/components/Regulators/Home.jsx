    ...
    return (
        <>
            ...
            <div className='bg-gray-100'>
                <header className='px-14 py-3 flex items-center justify-between w-full bg-gradient-to-tr from-blue-600 to-blue-400 shadow-md'>
                    <div className='flex items-center gap-4'>
                        <img src={Logo} alt="logo" className='w-12' />
                        <h1 className='text-white text-3xl font-bold'>PharmaChain</h1>
                    </div>
                    <div className='flex items-center gap-4'>
                        <Link to='/login' className='bg-white text-blue-600 px-4 py-1 rounded-full shadow hover:bg-gray-100 transition'>
                        Login / Sign Up
                        </Link>
                    </div>
                </header>
                <main className='h-full'>
                    <section className='relative h-full pb-8'>
                        ...
                        <div className='flex w-full h-full justify-center'>
                            <div className='w-1/3 ml-20 flex flex-col justify-center gap-5 items-start'>
                                <h2 className='text-4xl font-bold text-gray-800 w-11/12'>
                                ...
                                <Link to='login' className='bg-blue-600 px-6 text-white py-2 rounded-full shadow hover:bg-blue-700 transition'>
                                    Get Started
                                </Link>
                            </div>
                            <div>
                    ...
                    <section className='relative flex justify-center py-10 z-20'>
                        <div className='text-center w-4/5 flex flex-col items-center'>
                            <h2 className='font-semibold text-3xl mb-4 text-gray-800'>Our Services</h2>
                            <p className='w-10/12 text-gray-700'>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 mt-8">
                                {cards.map((card) => (
                                    <div key={card.id} className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                                        <img src={card.img} alt="" className='h-20 mb-4' />
                                        <h2 className="text-xl font-bold text-gray-800 mb-2 text-center">{card.title}</h2>
                    ...
                    <section className='relative flex justify-center py-10 z-20 overflow-hidden'>
                        <div className='text-center w-4/5 flex flex-col items-center'>
                            <h2 className='font-semibold text-3xl mb-4 text-gray-800'>How It Works</h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 px-4 mt-8 w-2/3">
                                {workCard.map((card) => (
                                    <div key={card.id} className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                ...
                <footer className='bg-gradient-to-tr from-blue-600 to-blue-400 py-12 flex justify-evenly gap-10 text-white'>
                    <div className='w-[300px]'>
                        <p>
                            <span className='font-bold'>Ensuring Transparency in the Pharmaceutical Supply Chain </span> provides progressive, and affordable healthcare, accessible on mobile and online for everyone
                        </p>
                    </div>
                    <div>
                        <ul>

  ...
  return (
    <div className="SalesReport w-full p-10 bg-[#F7F7F7]">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-semibold text-[#333333]">Reports &gt; Dispatch Report</h2>
          <p className="text-sm text-[#666666]">Compliance report of entities.</p>
        </div>
      ...
      <div className="flex">
        <div className="w-7/12 p-4 bg-white rounded-lg shadow-md border border-[#E6E6E6]">
          <h3 className="mb-4 text-[#009099] font-semibold">Deliveries Made</h3>
      ...
      <div className="mt-6 p-4 bg-white rounded-lg shadow-md border border-[#E6E6E6]">
        <h3 className="mb-4 text-[#009099] font-semibold">Cumulative Deliveries Per Day</h3>
        <div className="h-64 relative">
